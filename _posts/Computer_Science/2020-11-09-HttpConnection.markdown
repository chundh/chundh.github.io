...
![short-lived connections](./image/Computer_Science/Short-lived connections.JPG)
...
![persistent connections](./image/Computer_Science/Persistent connections.JPG)
...
![http pipelining](./image/Computer_Science/http pipelining.JPG)
